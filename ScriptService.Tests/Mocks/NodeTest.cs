...
namespace ScriptService.Tests.Mocks {
    public class NodeTest {
        ...
        public static Task<object> Execute(IInstanceNode node, IDictionary<string, object> variables=null) {
            ...
            return node.Execute(new WorkflowInstanceState(new WorkableLogger(new NullLogger<NodeTest>(), new WorkableTask()), new StateVariableProvider(variables), s => null, null, null, false), CancellationToken.None);
        }
    }
}